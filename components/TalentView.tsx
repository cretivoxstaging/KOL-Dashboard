...
interface TalentViewProps {
  ...
  setSelectedZodiac: (val: string) => void;
}
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="bg-slate-200 text-slate-800 text-[12px] uppercase tracking-widest font-bold">
              ...
              <th className="p-5 text-center">Followers</th>
              ...
              currentItems.map((t, index) => (
                ...
                >
                  ...
                  <td className="p-5 text-center font-bold text-slate-700">
                    {t.totalFollowers?.toLocaleString("id-ID")}
                  </td>
              ...
              <div className="space-y-5">
                ...
                <div className="bg-slate-50 p-3 rounded-2xl border border-slate-100">
                  ...
                  <p className="text-sm font-bold text-green-600 flex items-center gap-2">
                    <Banknote size={16} className="text-green-600" /> Rp{" "}
                    {selectedDetail.rateCard.toLocaleString("id-ID")}
                  </p>
                </div>
              </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mt-6 px-2 gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-slate-400">
            Showing {indexOfFirstItem + 1} to {Math.min(indexOfLastItem, filteredTalent.length)} of {filteredTalent.length}
          </span>
        </div>
  ...
  return (
    <div className="flex items-center bg-white px-3 py-2 border border-slate-200 rounded-xl shadow-sm hover:border-[#1B3A5B]/30 transition-all">
      <select
        ...
        className="text-xs font-bold text-slate-700 outline-none bg-transparent cursor-pointer min-w-[80px]"
      >
