...
const TalentTable: React.FC<TalentTableProps> = ({
  ...
  const formattedSelectedContactPerson = selectedTalent
    ? formatPhoneNumber(String(selectedTalent.contactPerson || ""))
    : "";
  ...
  const handleUpdate = async (
    ...
    try {
      ...
      const payload = {
        ...
        contact_person: formatPhoneNumber(
          String(updatedTalent.contactPerson || ""),
        ),
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-2">
                  <div>
                    ...
                    {formattedSelectedContactPerson ? (
                      <a
                        href={`https://wa.me/${formattedSelectedContactPerson}`}
                        target="_blank"
                        rel="noopener noreferrer"
